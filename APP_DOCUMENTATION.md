...
# Mazerations-Meister V 1.0 - App Dokumentation

## 1. Anwendungsbeschreibung

**Mazerations-Meister V 1.0** ist ein spezialisiertes Werkzeug, das für Destillerien, Likörhersteller und Betriebe entwickelt wurde, die mit der Mazeration von Kräutern und anderen pflanzlichen Stoffen arbeiten. Die Anwendung dient primär drei Zwecken:
