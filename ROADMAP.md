...
- [ ] 🔜 **Aufgabe 17 – GFKC-Verschnitt-Buchung: ZURÜCKGESTELLT, Bestandsaufnahme + Fachkontext vollständig (26.09.2026).** Start geplant für die Woche ab 29.09.2026. Fachkontext aus separatem Claude-Desktop-Projekt nachgeliefert und eingearbeitet: `docs/GFKC-FACHKONTEXT-REZEPTUR-2026-09.md` (Referenzrezeptur, Rechenmethodik, IFS-Geschäftsregel Ziel-ABV 53,5 %, neue fix/reduzierbar-Komponentenlogik für GFKC-O nötig). **Nicht vorher implementieren.**
